...
function init() {
  ...
  //Texture of the cube
  let textureArray = [];
  const texture_nx = new THREE.TextureLoader().load("nx.jpg");
  const texture_ny = new THREE.TextureLoader().load("px.jpg");
  const texture_nz = new THREE.TextureLoader().load("py.jpg");
  const texture_px = new THREE.TextureLoader().load("ny.jpg");
  const texture_py = new THREE.TextureLoader().load("nz.jpg");
  const texture_pz = new THREE.TextureLoader().load("pz.jpg");
  ...
  for (let i = 0; i < 6; i++) textureArray[i].side = THREE.BackSide;
